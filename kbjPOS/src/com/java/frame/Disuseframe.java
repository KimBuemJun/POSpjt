...
import com.java.event.Event_btnCancelinDf;

public class Disuseframe extends JFrame {
	...
	public Disuseframe() {
		...
		JButton btnOrder = new JButton("저장");
		...
		btnCancel.addActionListener(new Event_btnCancelinDf(this));
